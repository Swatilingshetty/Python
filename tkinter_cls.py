...
# 18/03/24
# tkinter - its used for building desktop application..

# import tkinter
# from tkinter import Frame,Button,Label,StringVar

# step1:creating the screen of calculater.

# root_var=tkinter.Tk()

# root_var.mainloop()

# step2: fixing the calculater screen to the specific location on the main screen 

# root_var=tkinter.Tk()

# # root_var.geometry('400x450')
# # root_var.mainloop()

# root_var.geometry('400x450')
# root_var.resizable(0,0)
# root_var.title('calculater')
# root_var.mainloop()

# step3: Divide the screen into 4 frames.
# root_var=tkinter.Tk()
# root_var.geometry('400x450')
# root_var.resizable(0,0)
# root_var.title('calculater')
...
# frame3=Frame(root_var,bg="orange")
# frame3.pack(fill='both',expand=True)

# frame4=Frame(root_var,bg="black")
# frame4.pack(fill='both',expand=True)

# frame5=Frame(root_var,bg="green")
...
# btnalnus=Button(frame2,text='-',font=('verdana',20),border=0)
# btnalnus.pack(fill='both',expand=True,side='left')
...
# #step5: creating the label for displaying the expression..

# root_var=tkinter.Tk()
# # root_var=tkinter.Tk()
# root_var.geometry('400x450+300+100')
# root_var.resizable(0,0)
# root_var.title('calculater')
...
# root_Label=Label(root_var,text="this is label area",anchor='sw',font=('vardana',20),background='red',textvariable=data)
...
# btnalnus=Button(frame2,text='-',font=('verdana',20),border=0,command=btnalnus_is_clicked)
# btnalnus.pack(fill='both',expand=True,side='left')
